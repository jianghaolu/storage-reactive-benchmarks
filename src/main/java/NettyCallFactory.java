        ...
        return new Call() {
            ...
            public Response execute() throws IOException {
                try {
                    ...
                    fullHttpRequest.headers().set(HttpHeaders.Names.HOST, request.url().host());
                    fullHttpRequest.headers().set(HttpHeaders.Names.CONNECTION, HttpHeaders.Values.KEEP_ALIVE);
                    fullHttpRequest.headers().set(HttpHeaders.Names.CONTENT_LENGTH, fullHttpRequest.content().readableBytes());
    ...
    public class HttpClientInboundHandler extends ChannelInboundHandlerAdapter {
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
            if (msg instanceof HttpResponse)
            {
                ...
                res.contentType = response.headers().get(HttpHeaders.Names.CONTENT_TYPE);
                res.contentLength = Long.parseLong(response.headers().get(HttpHeaders.Names.CONTENT_LENGTH));
